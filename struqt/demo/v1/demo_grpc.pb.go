...
// All implementations should embed UnimplementedBasicServiceServer
// for forward compatibility
type BasicServiceServer interface {
	JsonRpc(context.Context, *JsonRpcRequest) (*JsonRpcResponse, error)
}

// UnimplementedBasicServiceServer should be embedded to have forward compatible implementations.
